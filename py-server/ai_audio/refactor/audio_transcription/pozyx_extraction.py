...
COLOR_TO_ID = {"blue": 27261, "red": 27226, "green": 27176, "yellow": 27152, "white": 27261, "black": 27152}
ID_TO_COLOR = {"27261": "blue", "27226": "red", "27176": "green", "27152": "yellow", "27261": "white", "27152": "black"}

RED_ID = 27226
BLUE_ID = 27261
GREEN_ID = 27176    # before 318, the green id is 27160
YELLOW_ID = 27152
# 2022, the white id is 27261
WHITE_ID = 27261
BLACK_ID = 27152
###############################
...
def get_interpolated_data(data_frame, audio_start_timestamp: float, sensor_id):
    ...
    print("length of processed pozyx data is {} for {}".format(len(pozyx_x), sensor_id))
...
def extract_interpolate_single_session(raw_pozyx_path: str, sync_txt_path: str):
    ...
    for an_id in a_dict:
        ...
        interpolated_dict[an_id] = get_interpolated_data(a_dict[an_id], audio_start_timestamp, an_id)
