...
from data_cleaner.formation_detection.audio_code import COLORS
from data_cleaner.formation_detection.audio_code import extract_vad
from data_cleaner.formation_detection.location_code import ID_TO_COLOR
from data_cleaner.formation_detection.location_code import extract_interpolated_pozyx_with_yaw
from data_cleaner.formation_detection.location_code import extract_loction_dict
...
def extract_information_with_yaw(audio_folder_path: str, pozyx_json_path: str, sync_path: str,
                                 fov_thres: int, dist_thres: int, absolute_thres: int,
                                 testing: bool = False,
                                 ground_truth_path: str = "",
...
if __name__ == '__main__':
    ...
    extract_information_with_yaw(path_audio_folder, path_pozyx_json, sync_path,
