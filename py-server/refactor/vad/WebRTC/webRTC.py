...
def experiment_VAD_on_bad_case():
    ...
    # logger().info("180 no power up")
    # do_vad("data/180 blue no empowered .wav", 3)
    # logger().info("195 power up")
    # do_vad("data/195 blue power up.wav", 3)
    # logger().info("195 no power up")
    # do_vad("data/195 blue no power up.wav", 3)
    # logger().info(do_vad("data/216/simulation_GREEN_01-Sep-2021_13-19-37-929_audio.wav", 3))
    # logger().info(do_vad("data/216 full for test2.wav", 3))
    logger().info(do_vad("data/173 t.wav", 3))
...
if __name__ == '__main__':
    ...
    # logger().info(do_vad("Rio/Session6  - Tracker 26656 T1 - 180418_1359.wav", 3))
