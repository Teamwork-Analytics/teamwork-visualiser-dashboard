...
def speech2text_CMU(an_audio_path: str):
    ...
    try:
        ...
        # logger().info("Sphinx thinks you said:   " + recognition_result)
...
if __name__ == '__main__':
    ...
    testing_detection()
    # logger().info(str(datetime.timedelta(seconds=100)))
